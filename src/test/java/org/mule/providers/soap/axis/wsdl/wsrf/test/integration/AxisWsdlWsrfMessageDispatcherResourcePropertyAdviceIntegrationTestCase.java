...
public class AxisWsdlWsrfMessageDispatcherResourcePropertyAdviceIntegrationTestCase extends FunctionalTestCase
{
     ...
     */
    public final void testCallSingleInstanceGlobusServiceByMessageFactoryAndGetResourceProperty()
        throws Exception
    {
     ...
     * Test a single Call invocation method of Globus Grid Service using a Mule
     * Message with ResourceKey created from factory service and perform a
     * GetResourceProperty Operation in standalone mode without Axis method
     * invocation @throws Exception exception TODO WSRF-24: error in standalone mode
     */
    /*
     * public final void
     * testCallSingleInstanceGlobusServiceByMessageFactoryAndGetResourcePropertyStandaloneMode()
     * throws Exception { MuleClient client = new MuleClient(); Map props = new
     * HashMap(); props.put("style", "wrapped"); props.put("use", "literal");
     * //props.put(MuleProperties.MULE_SOAP_METHOD, method);
     * //props.put(WSRFParameter.SERVICE_NAMESPACE,
     * Messages.getString("RESOURCE_KEY"));
     * props.put(WSRFParameter.SERVICE_NAMESPACE,
     * MessagesTest.getString("SERVICE_NAMESPACE_URI"));
     * props.put(WSRFParameter.RESOURCE_KEY_NAME,
     * MessagesTest.getString("RESOURCE_KEY_NAME"));
     * props.put(WSRFParameter.RETURN_QNAME, MessagesTest.getString("RETURN_QNAME"));
     * props.put(WSRFParameter.RETURN_QTYPE, new javax.xml.namespace.QName(
     * MessagesTest.getString("SERVICE_NAMESPACE_URI"),
     * MessagesTest.getString("RETURN_QTYPE_NAME")));
     * //props.put(WSRFParameter.RETURN_CLASS,
     * Class.forName(MessagesTest.getString("RETURN_CLASSNAME")));
     * //props.put(WSRFParameter.SOAP_ACTION_URI,
     * MessagesTest.getString("SOAP_ACTION_URI")); //factory properties
     * props.put(WSRFParameter.WSRF_FACTORY_SERVICE_ADDRESS,
     * MessagesTest.getString("FACTORY_SERVICE_ADDRESS")); //Add WsResourceProperty
     * property props.put(WSRFParameter.WSRF_RESOURCEPROPERTY_OPERATION,
     * MessagesTest.getString("RESOURCE_PROPERTY_OPERATION"));
     * props.put(WSRFParameter.WSRF_RESOURCEPROPERTY_NAME,
     * MessagesTest.getString("RESOURCE_PROPERTY_NAME"));
     * props.put(WSRFParameter.WSRF_RESOURCEPROPERTY_NS ,
     * MessagesTest.getString("RESOURCE_PROPERTY_NS"));
     ...
     * assertNotNull(result); assertNotNull(result.getPayload());
     * assertNotNull(result.getProperty(WSRFParameter.RESOURCE_KEY));
     * assertNotNull(result.getProperty(WSRFParameter.WSRF_MESSAGE_ELEMENT_ARRAY_SOAP_RESPONSE));
     * System.out.println(result.getPayload()); System.out.println("New resource Key: " +
     * result.getProperty(WSRFParameter.RESOURCE_KEY));
     * Logger.getLogger(this.getClass()).log(Level.INFO, this.getClass().getName() + " : "
     * +"Result from GetResourceProperty: " +
     * MessagesTest.getString("RESOURCE_PROPERTY_NAME") + "= " +
     * result.getProperty(WSRFParameter.WSRF_MESSAGE_ELEMENT_ARRAY_SOAP_RESPONSE)); }*
     * /** Test a single Call invocation method of Globus Grid Service using a Mule
     * Message with ResourceKey created from factory service and perform on sequence :
     * an Update, Delete , Insert of SetResourceProperty Operation Test on String
     * Resource Property type @throws Exception exception
     */
    public final void testCallSingleInstanceGlobusServiceByMessageFactoryAndSetResourcePropertyUpdateDeleteInsert()
        throws Exception
    {
        MuleClient client = new MuleClient();
        SoapMethod method = new SoapMethod(new QName("", MessagesTest.getString("SOAP_METHOD_NAME")));
 ...
 *  Test a single Call invocation method of Globus Grid Service using a Mule
     * Message with ResourceKey created from factory service and perform on sequence :
     * an Update, Delete , Insert of SetResourceProperty Operation Test on Complex type resource property
 * @throws Exception  exception
 */
    public final void testCallSingleInstanceGlobusServiceByMessageFactoryAndSetResourcePropertyUpdateDeleteInsertComplexRPType()
    throws Exception
{
    MuleClient client = new MuleClient();
    SoapMethod method = new SoapMethod(new QName("", MessagesTest.getString("SOAP_METHOD_NAME")));
    ...
    props.put(WSRFParameter.WSRF_RESOURCEPROPERTY_OPERATION,
        MessagesTest.getString("RESOURCE_SET_PROPERTY_OPERATION"));
    props.put(WSRFParameter.WSRF_RESOURCEPROPERTY_NAME,
        MessagesTest.getString("RESOURCE_PROPERTY_COMPLEX_NAME_TO_SET"));
    props.put(WSRFParameter.WSRF_RESOURCEPROPERTY_NS, MessagesTest.getString("RESOURCE_PROPERTY_NS"));
    props.put(WSRFParameter.RP_SET_OPERATION_TYPE, "update");
    
    MessageElement value = getValue();
    ...
    assertEquals(resp.getObjectValue(InfoEntryCatalogType.class), value.getObjectValue(InfoEntryCatalogType.class));
 ...
 * @return
 */
private MessageElement getValue()
{
    MessageElement m;
        ...
        d.setReturnCode("1");
        d.setSunt("snt");
        d.setIDFile("id011111");
        
        OsdEntry[] osdEntries = new OsdEntry[2];
        
        OsdEntry osd = new OsdEntry();
        osd.setAddressEPR("http://www.epr.it/address");
        osd.setSubLengthByte(2311);
        osd.setPathFileID("path1");
        osdEntries[0] = osd;
        OsdEntry osd1 = new OsdEntry();
        osd1.setAddressEPR("http://www.epr.it/address2");
        osd1.setSubLengthByte(21123);
        osd1.setPathFileID("path1");
        osdEntries[1] = osd1;
        d.setOsd(osdEntries);
        d.setOsd(0,osd);
        
        //TODO raffaele.picardi: write documentation on confluence
        m = new MessageElement(new javax.xml.namespace.QName(MessagesTest.getString("RESOURCE_PROPERTY_NS"), "InfoEntryCatalogType") , d);
