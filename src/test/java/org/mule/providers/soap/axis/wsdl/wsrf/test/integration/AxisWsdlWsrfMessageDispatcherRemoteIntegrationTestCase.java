 ...
 *
 */
public class AxisWsdlWsrfMessageDispatcherRemoteIntegrationTestCase extends FunctionalTestCase
{
    /**
     * Constructor
     *
     */
    public AxisWsdlWsrfMessageDispatcherRemoteIntegrationTestCase () 
    {
...
protected final String getConfigResources()
    {
        return "axis-wsdl-wsrf-globus-grid-service-remote-mule-config.xml";
    }
/**
 * 
