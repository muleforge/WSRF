...
public class GetResourcePropertyWsrfCommand extends AbstractWsrfCommand
{
    ...
    protected void handleExecute() throws WSRFException
    {
        ...
        // operationRP defined
        String propertyName = (String) event.getMessage().getProperty(
            WSRFParameter.WSRF_RESOURCEPROPERTY_NAME);
        if (propertyName == null)
        {
            ...
            Logger.getLogger(this.getClass()).log(
                ...
                this.getClass().getName() + " : "
                                + " Skipped WS-RP operation : no resource property name defined  "
                                + WSRFParameter.WSRF_RESOURCEPROPERTY_NAME);
        ...
        if (nsProperty == null)
        {
            ...
            Logger.getLogger(this.getClass()).log(
                Level.ERROR,
                this.getClass().getName() + " : "
                                + " Skipped WS-RP operation : no namespace resource property  defined  "
                                + WSRFParameter.WSRF_RESOURCEPROPERTY_NS);
        ...
        if (resourceKey == null && call != null)
        {
            ...
            Logger.getLogger(this.getClass()).log(
                Level.ERROR,
                this.getClass().getName() + " : "
                                + " Skipped WS-RP operation : no resourceKey  property  defined  "
                                + WSRFParameter.RESOURCE_KEY);
        ...
        try
        {
            ...
            GenericServiceAddressingLocator serviceLocator = new GenericServiceAddressingLocator(
                new FileProvider(AxisWsdlConnector.DEFAULT_MULE_AXIS_CLIENT_CONFIG));
            ...
            catch (Exception e)
            {
                Logger.getLogger(this.getClass()).log(
                    Level.ERROR,
                    this.getClass().getName() + " : "
                                    + " Error during port type port loading. WS-RP operation skipped");
                e.printStackTrace();
                return;
            }
     ...
     /*       if (isStandalone)
            {
                ...
                if (call == null)
                {
                    // call is not created yet.: advice can add property to event
                    // message . so next time , when call is created before method
                    // continues perform its operations
                    Logger.getLogger(this.getClass()).log(
                        Level.DEBUG,
                        this.getClass().getName() + " : "
                                        + " Pre  WS-RP operation : add required initial properties message");
                    ...
                    if (operationRP.equals(WSRFParameter.GET_RESOURCE_PROPERTY))
                    {
                        ...
                        // TODO raffaele.picardi: payload of message needs to be
                        // Object[] {} of 1 - size
            ...
            if (isStandalone && response == null)
            {
                Logger.getLogger(this.getClass())
                    .log(
                        ...
                        this.getClass().getName()
                                        + " : "
                                        + " Getting Resource Property in standalone mode:  "
                                        + " response invocation will be add in payload message of wsdl provider invocation");
        ...
        this.wsrfExtraResponseMap.put(WSRFParameter.WSRF_MESSAGE_ELEMENT_ARRAY_SOAP_RESPONSE,
            response.get_any());
        Logger.getLogger(this.getClass()).log(
            Level.INFO,
